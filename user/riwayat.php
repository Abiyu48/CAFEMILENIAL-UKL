...
<section class="riwayat" id="riwayat">
    <h1 class="heading"> <span>Purchase</span> History</h1>
    <div class="row">
        <div class="content">
                ...
                <table>
                    ...
                    <?php while($row = mysqli_fetch_assoc($result)): ?>
                        ...
                        <tr>
                            ...
                            <td>Rp <?= number_format($row['total_transaction'], 0, ',', '.') ?></td>
                            <td><?= htmlspecialchars($row['transaction_method']) ?></td>
                            <td><?= htmlspecialchars($row['calender_transaction']) ?></td>
                            <td><?= htmlspecialchars($row['time_transaction']) ?></td>
                        </tr>
                    <?php endwhile; ?>
                </table>
            <?php else: ?>
